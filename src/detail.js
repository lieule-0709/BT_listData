              ...
              <div>
                ...
                {(user.fullName) &&
                  <div>
                    ...
                    <input type="text" id="editFullName" defaultValue={user.fullName} name="fullName" />
                  </div>
                }

                <label htmlFor="password"><b>Password</b></label>
                <input type="password" id="editPassword" placeholder="Enter new password" name="password" />
